...
const imageThumbnails = {
  ...
  cricklytics: '/images/projects/cricket.png',
...
const projects = [
  {
    ...
    tech: ['Python', 'FastAPI', 'Scikit-learn', 'TensorFlow','nltk', 'FAISS', 'HuggingFace', 'React', 'Docker','groq','plotly'],
    featured: true,
    icon: <FaRobot />,
  ...
  },
  {
    ...
    tech: ['Python', 'TensorFlow', 'LSTM', 'mlops', 'Pandas','plotly'],
    featured: true,
    icon: <FaChartLine />,
  ...
  {
    title: 'Cricklytics',
    subtitle: 'Cricket Analytics & Prediction System',
    desc: 'Production-ready cricket analytics platform built on ball-by-ball match data for International T20 and IPL competitions. Uses separate ML pipelines per competition for first-innings score prediction, second-innings win probability, and real-time chase forecasting with artifact-based inference.',
    tech: ['Python', 'Pandas','numpy','plotly', 'Scikit-learn', 'Flask', 'Docker','Mlops','Hugging Face Spaces'],
    featured: true,
    icon: <FaChartLine />,
    thumbnail: imageThumbnails.cricklytics,
    liveUrl: 'https://naveen-2007-cricklytics.hf.space/',
    gradient: 'linear-gradient(135deg, #0a1f45 0%, #0e3d2d 100%)',
  },
  {
  ...
  },
  {
    ...
    tech: ['Python', 'LangChain','Langgraph', 'FAISS', 'HuggingFace', 'FastAPI','groq','streamlit'],
    icon: <FaSearch />,
